          ...
          >
            ...
            <li>
              <div className="mt-50 w-[314px] items-center justify-between ">
                <Link to={"/sign-up"}>
                  <button className="w-[120px] h-[61px] rounded-[8px] border-[2px] border-[#f5f5f5] p-[10px] text-[20px] text-[#f5f5f5] font-[400] font-[regular] font-[Exo 2] text-center cursor-pointer hover:bg-[#3d9970] hover:opacity-60 my-2">
                    Sign Up
                  </button>
                </Link>
                <Link to={"/sign-in"}>
                  <button className="w-[120px] h-[61px] rounded-[8px] bg-[#3d9970] p-[10px] text-[20px] text-[#f5f5f5]  border-[2px] border-[#f5f5f5] font-[500] font-[medium] font-[Exo 2] text-center cursor-pointer  hover:opacity-60">
                    Login
                  </button>
                </Link>
              </div>
